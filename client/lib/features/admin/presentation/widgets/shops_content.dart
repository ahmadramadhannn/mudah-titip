...
/// Embeddable shop verification content widget.
/// Use this inside the admin dashboard tabs or as a standalone page.
class ShopsContent extends StatefulWidget {
  const ShopsContent({super.key});
